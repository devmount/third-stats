	...
	<div class="tab-area">
		...
		<div class="tab-content">
			...
			<bar-chart
				...
				:horizontal="true"
			/>
			<div v-if="tabLeader === tabsLeader.contactsReceived && !receivedContactLeadersChartDataExists" class="tab-empty">
				...
				<div v-html="t('stats.charts.contactsReceived.empty')"></div>
			</div>
			...
			<bar-chart
				...
				:horizontal="true"
			/>
			<div v-if="tabLeader === tabsLeader.contactsSent && !sentContactLeadersChartDataExists" class="tab-empty">
				<ts-icon size="large" variant="gray" weight="thin">
					<path stroke="none" d="M0 0h24v24H0z" fill="none" />
					<path
						d="M12.983 8.978c3.955 -.182 7.017 -1.446 7.017 -2.978c0 -1.657 -3.582 -3 -8 -3c-1.661 0 -3.204 .19 -4.483 .515m-2.783 1.228c-.471 .382 -.734 .808 -.734 1.257c0 1.22 1.944 2.271 4.734 2.74"
				...
				<div v-html="t('stats.charts.contactsSent.empty')"></div>
			</div>
			...
			<bar-chart
				...
				:horizontal="true"
			/>
			<div v-if="tabLeader === tabsLeader.contactsJunk && !junkContactLeadersChartDataExists" class="tab-empty">
				<ts-icon size="large" variant="gray" weight="thin">
					<path stroke="none" d="M0 0h24v24H0z" fill="none" />
					<path
						d="M12.983 8.978c3.955 -.182 7.017 -1.446 7.017 -2.978c0 -1.657 -3.582 -3 -8 -3c-1.661 0 -3.204 .19 -4.483 .515m-2.783 1.228c-.471 .382 -.734 .808 -.734 1.257c0 1.22 1.944 2.271 4.734 2.74"
				...
				<div v-html="t('stats.charts.contactsJunk.empty')"></div>
			</div>
		</div>
	</div>
</template>
