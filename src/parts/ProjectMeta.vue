	...
	<section>
		...
		<div class="d-flex gap-1 justify-center mt-2">
			...
			<ts-button
				...
				outline
				variant="accent2"
				v-tooltip="compact ? t('cta.translate') : null"
			>
				<ts-icon size="tiny" variant="accent2">
					<path stroke="none" d="M0 0h24v24H0z" fill="none" />
					<path d="M4 5h7" />
...
const links = {
	...
	share:
		'https://mastodonshare.com/?text=ThirdStats%20-%20' +
		t('extensionDescription.message') +
		'%20%40devmount%40mstdn.io%20%23thunderbird&url=https://addons.thunderbird.net/thunderbird/addon/thirdstats',
